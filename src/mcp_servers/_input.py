"""Mouse / keyboard / screenshot tools via pyautogui + mss.

Mirrors the Anthropic computer-use API action surface (screenshot, click,
type, key, scroll) so prompts written for one are largely portable.
"""
